...
export const metadata = buildMetadata({
  title: pages.cuidarHome.title,
  description: pages.cuidarHome.description,
  path: "/cuidar"
});

export default function CuidarHomePage() {
  const { hero } = pages.cuidarHome;
    ...
    <PageShell>
      <div className="max-w-3xl">
        ...
        <div className="mt-10 grid gap-4 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm md:grid-cols-2">
          <Link className="text-sm font-semibold text-zinc-900 hover:underline" href="/cuidar/what-we-do">What we do →</Link>
          <Link className="text-sm font-semibold text-zinc-900 hover:underline" href="/cuidar/who-its-for">Who it’s for →</Link>
          <Link className="text-sm font-semibold text-zinc-900 hover:underline" href="/cuidar/how-we-work">How we work →</Link>
          <Link className="text-sm font-semibold text-zinc-900 hover:underline" href="/cuidar/proof">Proof →</Link>
        </div>
      </div>
    </PageShell>
  );
